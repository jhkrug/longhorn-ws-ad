...
You must first link:../../../snapshots-and-backups/backup-and-restore/set-backup-target[set up a backup target]. If you skip this crucial step, the missing backup target will prevent Longhorn from creating a backup of the backing image.
