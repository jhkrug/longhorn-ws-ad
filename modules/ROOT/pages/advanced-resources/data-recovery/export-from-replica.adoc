...
+
More disks can be added to a node by either using the Longhorn UI or by using link:../../../nodes-and-volumes/nodes/default-disk-and-node-config/[a node label and annotation].
+
