...
+
Follow the link:../customizing-default-settings/[Customize default settings] to set taint tolerations by changing the value for the `taint-toleratio` default setting
+
[NOTE]
====
