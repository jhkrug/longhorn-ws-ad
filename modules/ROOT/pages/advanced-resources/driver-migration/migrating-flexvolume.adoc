...
. link:../../../snapshots-and-backups/backup-and-restore/create-a-backup[Back up existing volumes].
...
. Restore each volume. This link:../../../snapshots-and-backups/backup-and-restore/restore-statefulset[procedure] is tailored to the StatefulSet workload, but the process is approximately the same for all workloads.
