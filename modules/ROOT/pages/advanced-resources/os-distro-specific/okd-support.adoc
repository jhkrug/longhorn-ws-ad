...
Please refer to this section link:../../../deploy/install/install-with-helm/[Install with Helm] first.
...
For more information, see link:../../../deploy/install/install-with-kubectl[Install with Kubectl].

== Prepare A Customized Default Longhorn Disk (Optional)

To understand more about configuring the disks for Longhorn, please refer to the section link:../../../nodes-and-volumes/nodes/default-disk-and-node-config/#launch-longhorn-with-multiple-disks[Configuring Defaults for Nodes and Disks]
...
Please refer to the section link:../../../nodes-and-volumes/nodes/default-disk-and-node-config/#customizing-default-disks-for-new-nodes[Customizing Default Disks for New Nodes] to label and annotate storage node on where your device is by oc commands:
