...
* link:../../../snapshots-and-backups/backup-and-restore/set-backup-target[Set the backup target]. Longhorn saves the system backups to the remote backup store. You will see an error during creation when the backup target is unset.
+
