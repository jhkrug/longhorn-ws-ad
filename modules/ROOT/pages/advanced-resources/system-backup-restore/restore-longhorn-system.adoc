...
* Longhorn restores the resource from the link:../backup-longhorn-system#longhorn-system-backup-bundle[Longhorn System Backup Bundle].
...
+
See link:../backup-longhorn-system#create-longhorn-system-backup[Backup Longhorn System - Create Longhorn System Backup] for instructions.
...
* link:../../../references/settings/#concurrent-volume-backup-restore-per-node-limit[Concurrent volume backup restore per node limit]
* link:../../../references/settings/#concurrent-replica-rebuild-per-node-limit[Concurrent replica rebuild per node limit]
* link:../../../references/settings/#backup-target[Backup Target]
* link:../../../references/settings/#backup-target-credential-secret[Backup Target Credential Secret]
