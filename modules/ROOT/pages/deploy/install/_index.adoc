...
Please see link:../../best-practices/[Best Practices] for how to configure Longhorn for production usage.
...
To install Longhorn in an air gapped environment, refer to link:../install/airgap[this section.]

For information on customizing Longhorn's default settings, refer to link:../../advanced-resources/deploy/customizing-default-settings[this section.]

For information on deploying Longhorn on specific nodes and rejecting general workloads for those nodes, refer to the section on link:../../advanced-resources/deploy/taint-toleration[taints and tolerations.]
...
For the minimum recommended hardware, refer to the link:../../best-practices/#minimum-recommended-hardware[best practices guide.]
...
* Google Kubernetes Engine (GKE): See link:../../advanced-resources/os-distro-specific/csi-on-gke[Longhorn CSI on GKE].
* K3s clusters: See link:../../advanced-resources/os-distro-specific/csi-on-k3s[Longhorn CSI on K3s].
* RKE clusters with CoreOS: See link:../../advanced-resources/os-distro-specific/csi-on-rke-and-coreos[Longhorn CSI on RKE and CoreOS].
* OCP/OKD clusters: See link:../../advanced-resources/os-distro-specific/okd-support[OKD Support].
* Talos Linux clusters: See link:../../advanced-resources/os-distro-specific/talos-linux-support[Talos Linux Support].
* Container-Optimized OS: See link:../../advanced-resources/os-distro-specific/container-optimized-os-support[Container-Optimized OS Support].
...
* Talos Linux: See link:../../advanced-resources/os-distro-specific/talos-linux-support[Talos Linux Support].
* Container-Optimized OS: See link:../../advanced-resources/os-distro-specific/container-optimized-os-support[Container-Optimized OS Support]
...
SELinux enabled, see link:../../../../kb/troubleshooting-volume-attachment-fails-due-to-selinux-denials[the KB] for details.
