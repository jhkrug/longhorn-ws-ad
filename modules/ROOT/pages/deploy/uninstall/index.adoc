...
we introduce a new setting, link:../../references/settings/#deleting-confirmation-flag[deleting-confirmation-flag].
...
One reason can be that link:../../references/settings/#deleting-confirmation-flag[deleting-confirmation-flag] is `false`.
