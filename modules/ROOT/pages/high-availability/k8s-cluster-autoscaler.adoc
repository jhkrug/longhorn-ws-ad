...
If you want to unblock the Kubernetes Cluster Autoscaler scaling, you can set the setting link:../../references/settings#kubernetes-cluster-autoscaler-enabled-experimental[Kubernetes Cluster Autoscaler Enabled].
