...
You can find more detail about the setting options in the `Pod Deletion Policy When Node is Down` in the *Settings* tab in the Longhorn UI or link:../../references/settings/#pod-deletion-policy-when-node-is-down[Settings reference]
