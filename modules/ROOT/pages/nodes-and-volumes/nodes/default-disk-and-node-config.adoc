...
. Deploy Longhorn with `create-default-disk-labeled-nodes: true`, check link:../../../advanced-resources/deploy/customizing-default-settings[here] for customizing the default settings of Longhorn.
