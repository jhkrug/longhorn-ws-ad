...
You can set up a link:../../../snapshots-and-backups/scheduling-backups-and-snapshots/#set-up-recurring-jobs[RecurringJob] to periodically trim the filesystem.
...
link:../../../references/settings/#remove-snapshots-during-filesystem-trim[_Remove Snapshots During Filesystem Trim_].
