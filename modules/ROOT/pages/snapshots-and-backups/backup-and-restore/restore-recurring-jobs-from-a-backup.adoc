...
For more information on the setting `Restore Volume Recurring Jobs`, refer to the link:../../../references/settings/#restore-volume-recurring-jobs[settings] section.

For more information on how volume backup works, refer to the link:../../../concepts/#3-backups-and-secondary-storage[concepts] section.
