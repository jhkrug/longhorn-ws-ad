...
For more information about how the backupstore works in Longhorn, see the link:../../../concepts/#3-backups-and-secondary-storage[concepts section.]
...
Longhorn also supports setting up recurring snapshot/backup jobs for volumes, via Longhorn UI or Kubernetes Storage Class. See link:../../scheduling-backups-and-snapshots[here] for details.
...
*Result:* Longhorn can store backups in S3. To create a backup, see link:../create-a-backup[this section.]
...
*Result:* Longhorn can store backups in NFS. To create a backup, see link:../create-a-backup[this section.]
...
*Result:* Longhorn can store backups in CIFS. To create a backup, see link:../create-a-backup[this section.]
...
After configuring the above settings, you can manage backups on Azure Blob storage. See link:../create-a-backup[how to create backup] for details.
